...
class Family(object):
    ...
    def cousin(self, a, b):
       ...
       """
        ...
        node_a, node_b = self.depth_node(a), self.depth_node(b)
        removed = abs(node_a - node_b)
...
t, r = f.cousin("n", "e")
print "'n' is a", words[t], "cousin", r, "removed from 'e'"

t, r = f.cousin("h", "d")
print "'h' is a", words[t], "cousin", r, "removed from 'd'"

t, r = f.cousin("b", "j")
print "'b' is a", words[t], "cousin", r, "removed from 'j'"
