...
# http://www.codeskulptor.org/#user28_8ETjmpSrVC_1.py
...
ball_vel = [-random.randrange(1, 4), random.randrange(2, 5)]
...
def draw(c):
    ...
    if ball_pos[0] <= (PAD_WIDTH) and (ball_pos[1] < (paddle1_pos - HALF_PAD_HEIGHT) or ball_pos[1] > (paddle1_pos + HALF_PAD_HEIGHT)):
        spawn_ball(RIGHT)
        score2 += 1
    elif ball_pos[0] <= (PAD_WIDTH + BALL_RADIUS) and not (ball_pos[1] < (paddle1_pos - HALF_PAD_HEIGHT) or ball_pos[1] > (paddle1_pos + HALF_PAD_HEIGHT)):
        ball_vel[0] = -ball_vel[0] * 1.1
             
    if  ball_pos[0] >= (WIDTH - PAD_WIDTH) and (ball_pos[1] < (paddle2_pos - HALF_PAD_HEIGHT) or ball_pos[1] > (paddle2_pos + HALF_PAD_HEIGHT)):
        spawn_ball(LEFT)
        score1 += 1
    elif ball_pos[0] >= (WIDTH - PAD_WIDTH - BALL_RADIUS) and not (ball_pos[1] < (paddle2_pos - HALF_PAD_HEIGHT) or ball_pos[1] > (paddle2_pos + HALF_PAD_HEIGHT)):
            ball_vel[0] = -ball_vel[0] * 1.1
    ...
    # draw scores
    c.draw_text(str(score1), (160, 50), 48, "Green")
    c.draw_text(str(score2), (410, 50), 48, "Green")
